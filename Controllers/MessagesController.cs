...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : Controller
    {
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, MessageParams messageParams)
        {
            ...
            var messages = this._mapper.Map<IEnumerable<MessageForReturnDto>>(messagesFromRepo);
        ...
        public async Task<IActionResult> GetMessageThread(int userId, int id)
        {
            ...
            var messagesFromRepo = await this._repo.GetMessageThread(userId, id);

            var messageThread = this._mapper.Map<IEnumerable<MessageForReturnDto>>(messagesFromRepo);
        ...
        [HttpPost("{id}/read")]
        public async Task<IActionResult> MarkMessageAsReasd(int userId, int id)
        {
            if (userId != int.Parse(User.FindFirst(ClaimTypes.NameIdentifier).Value))
                return Unauthorized();
            ...
            throw new Exception("Failed to mark message as read in the database");
        }
    }
}